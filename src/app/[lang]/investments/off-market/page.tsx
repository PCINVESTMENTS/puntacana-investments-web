...
export async function generateMetadata({
    ...
    return {
        title: (lang === 'en' ? 'Off-Market Opportunities' : 'Oportunidades Off-Market') + ' | Punta Cana Investments',
        description: lang === 'en'
        ...
        openGraph: {
            title: lang === 'en' ? 'Private Off-Market Listings' : 'Listados Privados Off-Market',
            description: lang === 'en' ? 'Request access to our exclusive private portfolio.' : 'Solicite acceso a nuestro portafolio privado exclusivo.',
                    ...
                    <ScrollReveal>
                        <div className="text-center">
                            <span className="text-luxury-gold uppercase tracking-[0.3em] text-sm font-bold mb-4 block">
                                {lang === 'en' ? 'Private Collections' : 'Colecciones Privadas'}
                            </span>
                        ...
                        <ScrollReveal direction="right">
                            <div className="space-y-8">
                                <div className="flex gap-4">
                                    ...
                                    <div>
                                        <h3 className="text-xl font-bold text-white mb-2">
                                            {lang === 'en' ? 'Confidentiality' : 'Confidencialidad'}
                                        </h3>
                                ...
                                <div className="flex gap-4">
                                    ...
                                    <div>
                                        <h3 className="text-xl font-bold text-white mb-2">
                                            {lang === 'en' ? 'Private Invitations' : 'Invitaciones Privadas'}
                                        </h3>
                                        <p className="text-neutral-gray">
                                            {lang === 'en'
                                ...
                                <div className="pt-8">
                                    ...
                                    >
                                        {lang === 'en' ? 'Request Private Access' : 'Solicitar Acceso Privado'}
                                    </Link>
                                </div>
                            </div>
                        </ScrollReveal>
