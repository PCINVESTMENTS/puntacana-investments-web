    ...
    return (
        <section className="relative h-screen flex items-center justify-center overflow-hidden bg-primary-black">
            ...
            <div className="relative z-10 text-center px-4 max-w-5xl mx-auto flex flex-col items-center pointer-events-none">
                <div className="bg-black/70 md:bg-black/60 md:backdrop-blur-[4px] border border-white/10 rounded-sm p-6 md:p-10 shadow-2xl max-w-3xl mx-auto min-h-[400px] md:min-h-[300px] flex flex-col justify-center pointer-events-auto">
