        ...
        <section className="relative h-screen flex items-center justify-center overflow-hidden bg-primary-black">
            ...
            <div className="relative z-10 text-center px-4 max-w-5xl mx-auto flex flex-col items-center">
                <ScrollReveal delay={0.2} width="100%">
                    <div className="bg-black/30 backdrop-blur-sm border border-white/10 rounded-sm p-8 md:p-14 shadow-2xl max-w-4xl mx-auto">
                        <h1 className="text-4xl md:text-5xl lg:text-7xl font-bold mb-4 text-luxury-gold leading-tight font-serif uppercase tracking-wider drop-shadow-md">
                            {dict.title}
                        </h1>
                        <div className="h-1 w-24 bg-luxury-gold mx-auto my-6"></div>
